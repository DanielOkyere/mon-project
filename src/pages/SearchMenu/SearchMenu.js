				...
				<div className="col-span-1 border-r border-app-pink py-12 px-4">
					...
					<div className="my-8">
						...
						<div className="flex">
							<input
								type="date"
								className="flex-1 mb-3 p-2 w-full rounded-sm mr-1"
								placeholder="From"
							/>
							<input
								type="date"
								className="flex-1 mb-3 p-2 w-full rounded-sm ml-1"
								placeholder="To"
							/>
						</div>
						<input
							...
							placeholder="Rooms"
						/>
						<button className="my-2 bg-app-pink text-white w-full py-2 rounded">
							Search
						</button>
					</div>
				</div>
