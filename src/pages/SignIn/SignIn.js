  ...
  return (
    <div className='SignIn flex items-center justify-center w-full'>
        <div className='login-div flex flex-col items-center'>
          ...
          <button className='bg-app-pink p-2 w-72 text-app-white rounded text-md hover:bg-app-orange mb-3'>Sign in</button>
          <button className='border border-app-pink p-2 w-72 text-app-pink text-md rounded hover:border-app-orange hover:text-app-orange mb-3'>Sign in with Google</button>
          ...
          <div className='sign Up prompt flex items-center justify-center'>
            ...
            <button className='text-app-pink text-sm hover:text-app-orange font-bold'>Sign Up</button>
          </div>
        </div>
    </div>
  )
