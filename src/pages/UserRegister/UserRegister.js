    ...
    <div className='UserRegister flex items-center justify-center w-full'>
      <div className='SignInDiv flex-flex-wrap'>
        ...
        <div className='phoneNum'>
          ...
          <input type="text" className='mb-3 p-2 w-48 rounded-sm mr-2' placeholder=''/>
          </div>
        </div>
        <div className='DoB'>
        ...
        <input type="password" className='mb-6 p-2 w-full rounded-sm' placeholder='Password'/>
        <input type="password" className='mb-3 p-2 w-full rounded-sm' placeholder='Confirm Password'/>
        <button className='w-full bg-app-pink text-app-white p-3 rounded text-sm'>Sign Up</button>
        <div className='prompt m-2 flex items-center justify-center p-2'>
          <h6 className='text-sm'>Already have an account?</h6>
          <button className="ml-2 text-app-pink text-sm font-bold">Login</button>
        </div>
      </div>
    </div>
  )
