  ...
  return (
    ...
    <Router>
      <Routes>
        ...
        <Route path="/register/host/credentials" element={<HostRegister1/>} />
        <Route path="/register/host/property-type" element={<HostRegister2/>} />
        <Route path="/register/host/location-details" element={<HostRegister3/>} />
        <Route path="/register/host/property-details" element={<HostRegister4/>} />
